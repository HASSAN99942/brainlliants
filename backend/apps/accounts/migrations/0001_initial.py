    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exam_level', models.CharField(blank=True, choices=[('GCE_OL', 'GCE O/L'), ('GCE_AL', 'GCE A/L'), ('BAC_A', 'BAC A'), ('BAC_C', 'BAC C'), ('BAC_D', 'BAC D'), ('BAC_E', 'BAC E'), ('BAC_TECH', 'BAC Technique'), ('BEPC', 'BEPC'), ('PROBATOIRE', 'Probatoire'), ('HND', 'HND'), ('CEP', 'CEP')], max_length=20, null=True)),
                ...
                ('interface_language', models.CharField(choices=[('en', 'English'), ('fr', 'French')], default='en', max_length=5)),
                ('is_verified', models.BooleanField(default=False)),
                ('is_teacher_verified', models.BooleanField(default=False)),
                ('is_pro', models.BooleanField(default=False)),
                ('pro_expiry', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('admin_user', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='managed_school', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'schools',
            },
